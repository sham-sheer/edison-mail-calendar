      ...
      case 'updateOne':
        switch (state.providerType) {
          ...
          case EXCHANGE:
            ...
            //       .update({
            //         $addToSet: {
            //           recurrenceIds: singleAppointment.Start.MomentDate.format(
      ...
      case 'updateFuture':
        switch (state.providerType) {
          case EXCHANGE:
            ...
            //   const newRecurr = this.createEwsRecurrenceObj(recurrMasterAppointment.Recurrence);
            ...
            //       console.log(allExchangeEvents, expandedItems, localPrevExpandedItems);
            ...
            //           asyncDeleteExchangeEvent(deletingAppt, user, () => {
            ...
            //         (event) =>
            //           moment(event.toJSON().start.dateTime).isAfter(
            //             singleAppointment.Start.MomentDate
            //           ) ||
            //           moment(event.toJSON().start.dateTime).isSame(
            //             singleAppointment.Start.MomentDate
            //           )
            //       );
